...
class MarketTest < Minitest::Test
  ...
  def test_sorted_item_list
    ...
    market.stubs(:items).returns([item1, item2,item3, item4])
    names = ["Banana Nice Cream", "Peach", "Peach-Raspberry Nice Cream", "Tomato"]

    assert_equal names, market.sorted_item_list
  end
